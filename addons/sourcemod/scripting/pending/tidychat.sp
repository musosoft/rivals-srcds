...
#define PLUGIN_VERSION "0.4-private"
...
new Handle:g_hChatTrigger = INVALID_HANDLE;
new bool:bTF2 = false;

public Plugin:myinfo = 
{
	name = "Tidy Chat",
	author = "linux_lover, muso.sk",
...
public OnPluginStart()
{
	...
	g_hChatTrigger = CreateConVar("sm_tidychat_trigger", "0", "0/1 Tidy chats starting with !");
	...
	// Listeners for sm_tidychat_trigger
...
{ 
	if(GetConVarInt(g_hEnabled) && GetConVarInt(g_hChatTrigger))
	{
