...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_ccc", Command_Color, ADMFLAG_CUSTOM2, "Open Custom Chat Colors Menu");
	RegAdminCmd("sm_reload_cccm", Command_Reload, ADMFLAG_ROOT, "Reloads Custom Chat Colors Menu config");
	RegAdminCmd("sm_tagcolor", Command_TagColor, ADMFLAG_CUSTOM2, "Change tag color to a specified hexadecimal value");
	RegAdminCmd("sm_resettag", Command_ResetTagColor, ADMFLAG_CUSTOM2, "Reset tag color to default");
	RegAdminCmd("sm_namecolor", Command_NameColor, ADMFLAG_CUSTOM2, "Change name color to a specified hexadecimal value");
	RegAdminCmd("sm_resetname", Command_ResetNameColor, ADMFLAG_CUSTOM2, "Reset name color to default");
	RegAdminCmd("sm_chatcolor", Command_ChatColor, ADMFLAG_CUSTOM2, "Change chat color to a specified hexadecimal value");
	RegAdminCmd("sm_resetchat", Command_ResetChatColor, ADMFLAG_CUSTOM2, "Reset chat color to default");
...
public OnClientPostAdminCheck(iClient)
{
	...
	if(CheckCommandAccess(iClient, "sm_ccc_tag", ADMFLAG_CUSTOM2))
		g_bAccessColor[iClient][TAG] = true;
	if(CheckCommandAccess(iClient, "sm_ccc_name", ADMFLAG_CUSTOM2))
		g_bAccessColor[iClient][NAME] = true;
	if(CheckCommandAccess(iClient, "sm_ccc_chat", ADMFLAG_CUSTOM2))
		g_bAccessColor[iClient][CHAT] = true;
	if(CheckCommandAccess(iClient, "sm_ccc_hidetags", ADMFLAG_CUSTOM2))
