...
public OnClientPutInServer(client)
{
        ...
        && GetConVarInt(cvar_invalid_max) != _:PLAction_Nothing)
    {
        ...
        CPrintToChatAll("{chartreuse}[{dodgerblue}MapChooser{chartreuse}]{default} %t", "Too Many Players", map_max_players);
...
public OnClientDisconnect_Post(client)
{
        ...
        && GetConVarInt(cvar_invalid_min) != _:PLAction_Nothing)
    {
        ...
        CPrintToChatAll("{chartreuse}[{dodgerblue}MapChooser{chartreuse}]{default} %t", "Not Enough Players", map_min_players);
