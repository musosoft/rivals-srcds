...
#define AFKM_VERSION								"4.1.5-morecolors"
...
#if defined _colors_included
			if (g_bPrefixColors)
				CPrintToChat(i, "{chartreuse}[{dodgerblue}%s{chartreuse}]{default} %s", g_sPrefix, sBuffer);
			else
...
/*
			if (GameRules_GetProp("m_bWarmupPeriod") == 1)
				PrintToConsole(1, "Event_RoundStart - Warmup Round");
			else if (GameRules_GetProp("m_bWarmupPeriod") == 0)
				PrintToConsole(1, "Event_RoundStart - Not Warmup Round");
*/
